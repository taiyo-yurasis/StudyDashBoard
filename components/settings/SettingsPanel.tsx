...
import { DailyPlanSettings } from "@/components/settings/DailyPlanSettings";
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        ...
        <section className="rounded-md border border-line bg-panel p-5 shadow-subtle">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-4">
            ...
            <div className="rounded-md border border-line bg-panelSoft p-4">
              <p className="text-sm text-muted">毎日設定</p>
              <p className="mt-2 text-2xl font-semibold text-ink">{data.dailyPlans.length}</p>
            </div>
          </div>
